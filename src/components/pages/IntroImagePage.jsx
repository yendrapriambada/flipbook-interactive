...
const IntroImagePage = forwardRef(function IntroImagePage(props, ref) {
  return (
    <div className="page" ref={ref}>
      <div className="page-content page-hero-left">
        ...
        <p className="page-body-text">
          ...
          menambahkan berbagai jenis konten dalam flipbook ini untuk menciptakan
          pengalaman membaca yang interaktif dan menarik.
        </p>
